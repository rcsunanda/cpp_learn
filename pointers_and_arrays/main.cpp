...
//	int* pArr2 = stackArray2;
	...
	Cat* catPointerArray[size]; //Array of pointers on stack
	...
	//if you really want to modify, you need a const_cast (highly discouraged - only useful when dealing with faulting libs/APIs)
